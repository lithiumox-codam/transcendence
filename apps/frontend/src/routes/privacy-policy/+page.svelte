...
<main
	class="flex min-h-screen bg-gray-900 text-white items-center justify-center p-5"
>
	<div
		class="flex flex-col w-full max-w-4xl rounded-md border border-gray-700 bg-gray-800 text-white shadow-lg p-6"
	>
		<!-- Title -->
		<h1 class="text-3xl font-semibold text-cyan-400 mb-6 text-center">
			Privacy Policy
		</h1>
		...
		<section class="space-y-6">
			...
			<div>
				...
				<ul
					class="list-disc list-inside text-sm text-gray-300 space-y-2"
				>
