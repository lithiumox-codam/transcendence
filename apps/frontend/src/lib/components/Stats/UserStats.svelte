...
<div class="w-full max-w-md mx-auto group text-white">
	<div
		class="relative bg-black/50 border border-white/10 rounded-xl p-6 backdrop-blur-sm
		skew-[-2deg] group-hover:skew-0 transition-transform duration-300 shadow-[0_0_20px_rgba(0,255,255,0.05)]"
	>
		<h2
			class="text-center text-white text-2xl font-extrabold tracking-widest mb-6"
		>
			Your Stats
		</h2>
