	...
	>
		<div
			...
			style="position: absolute; top: {popout.position.y}px; left: {popout
				...
				.size.height}px;"
			class="bg-black/10 text-white shadow-lg rounded-lg overflow-hidden border border-white/10 flex flex-col backdrop-blur-md backdrop-filter"
		>
			<!-- Header with drag functionality -->
			<header
				class="flex items-center justify-between p-2 bg-black/20 border-b border-white/10 cursor-move backdrop-blur-md backdrop-filter"
				role="toolbar"
