    ...
    {#if results.length > 0}
        ...
        >
            {#each results as resultUser, i}
                <button
                    class="flex items-center w-full px-4 py-3 text-left hover:bg-white/20 transition-colors border-b border-white/10 last:border-b-0 {i ===
                    selectedIndex
                        ? 'bg-white/20'
                        : ''}"
                ...
                >
                    ...
                    <div
                        class="ml-3 w-6 h-6 rounded-full bg-white/10 border border-white/10 hover:bg-blue-600/30 flex items-center justify-center text-white transition-colors"
                    >
                        <Plus class="w-4 h-4" />
                    </div>
                </button>
